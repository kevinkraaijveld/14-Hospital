...
<div>
  <!-- Dit formulier gaat naar de functie 'createNewClient' in ClientController.php-->
  <form action="<?=URL?>client/createNewClient" method="POST" autocomplete="off">
    <label for="fname">Voornaam</label>
    <input type="text" id="client_firstname" name="client_firstname" minlength="2" maxlength="10" placeholder="Voornaam" >
