...
<div>
<!-- Dit formulier gaat naar de functie 'removeAClient' in ClientController.php-->
  <form action="<?=URL?>client/deleteThisClient/<?=$client[0]['client_id']?>" method="GET" autocomplete="off">
